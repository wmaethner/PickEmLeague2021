...
export class GameApi extends runtime.BaseAPI {
    ...
    /**
     */
    async gameAddGameSchedulePostRaw(requestParameters: GameAddGameSchedulePostRequest): Promise<runtime.ApiResponse<void>> {
    ...
    /**
     */
    async gameAddGameSchedulePost(requestParameters: GameAddGameSchedulePostRequest): Promise<void> {
        await this.gameAddGameSchedulePostRaw(requestParameters);
    }

    /**
     */
    async gameCreateGameForWeekPostRaw(requestParameters: GameCreateGameForWeekPostRequest): Promise<runtime.ApiResponse<Game>> {
        const queryParameters: runtime.HTTPQuery = {};
    ...
    /**
     */
    async gameCreateGameForWeekPost(requestParameters: GameCreateGameForWeekPostRequest): Promise<Game> {
    ...
    /**
     */
    async gameDeleteGameDeleteRaw(requestParameters: GameDeleteGameDeleteRequest): Promise<runtime.ApiResponse<void>> {
        const queryParameters: runtime.HTTPQuery = {};
    ...
    /**
     */
    async gameDeleteGameDelete(requestParameters: GameDeleteGameDeleteRequest): Promise<void> {
    ...
    /**
     */
    async gameGetGamesForWeekGetRaw(requestParameters: GameGetGamesForWeekGetRequest): Promise<runtime.ApiResponse<Array<Game>>> {
        const queryParameters: runtime.HTTPQuery = {};
    ...
    /**
     */
    async gameGetGamesForWeekGet(requestParameters: GameGetGamesForWeekGetRequest): Promise<Array<Game>> {

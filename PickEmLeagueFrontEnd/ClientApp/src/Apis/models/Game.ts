...
export function GameFromJSONTyped(json: any, ignoreDiscriminator: boolean): Game {
    ...
    return {
        ...
        'gameTime': !exists(json, 'gameTime') ? undefined : (new Date(json['gameTime'])),
        'gameTimeString': !exists(json, 'gameTimeString') ? undefined : json['gameTimeString'],
        'gameIsoString': !exists(json, 'gameIsoString') ? undefined : json['gameIsoString'],
        'gameResult': !exists(json, 'gameResult') ? undefined : GameResultFromJSON(json['gameResult']),
...
export function GameToJSON(value?: Game | null): any {
    ...
    return {
        ...
        'week': value.week,
        'gameTime': value.gameTime === undefined ? undefined : (value.gameTime.toISOString()),
